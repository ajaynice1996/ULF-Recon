...
if __name__ == "__main__":
    ...
    nifti_img = nib.load('./DataSRR_AJ/SRR/ajay_training_06/10mm/lf_mri_3DTSE_1.nii.gz')
    ...
    # -------------------------------
    vol_roll_z = np.roll(im, -10, axis=2)  # shift slices (Z-axis)
    visualize_volume(vol_roll_z, title="Roll Z (slices)")
    vol_roll_x = np.roll(vol_roll_z, 10, axis=1)   # shift horizontally (X-axis)
    ...
    make_nifti(
        im_resampled,
        fname='./DataSRR_AJ/SRR/ajay_training_06/10mm/lf_mri_3DTSE_1_resampled.nii.gz',
        mask=False,
        res=target_spacing,
        dim_info=[0, 1, 2]
    )
    ...
    make_nifti(
        im_axial,
        fname='./DataSRR_AJ/SRR/ajay_training_06/10mm/lf_mri_3DTSE_1_resampled_axial.nii.gz',
        mask=False,
        res=[2,2,2],
        dim_info=[0, 1, 2]
    )

    save_path_npy = './DataSRR_AJ/SRR/ajay_training_06/npy1/axial_circshift_1zy.npy'
