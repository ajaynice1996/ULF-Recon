#!/usr/bin/env python3
"""Generate 2mm NiftyMIC QC figures in axial/coronal/sagittal planes.

Creates 4x4 slice montages and mask overlays for:
- srr_geometry_check_2x2x2mm_3scan
- srr_final_2x2x2mm_3scan

Outputs are saved in:
- <output-dir>/niftymic_qc_2mm
- <fixed-fig-dir>/niftymic_qc_2mm
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Create 2mm NiftyMIC QC figures")
    p.add_argument(
        "--output-dir",
...
def main() -> None:
    ...
    qc_dir = output_dir / "niftymic_qc_2mm"
    fixed_qc_dir = fixed_fig_dir / "niftymic_qc_2mm"
    ...
    geometry_img = output_dir / "srr_geometry_check_2x2x2mm_3scan.nii.gz"
    geometry_mask = output_dir / "srr_geometry_check_2x2x2mm_3scan_mask.nii.gz"
    final_img = output_dir / "srr_final_2x2x2mm_3scan.nii.gz"
    final_mask = output_dir / "srr_final_2x2x2mm_3scan_mask.nii.gz"

    make_fig_set("geometry_check_2mm_3scan", geometry_img, geometry_mask, qc_dir)
    make_fig_set("final_2mm_3scan", final_img, final_mask, qc_dir)
    ...
    print("=" * 80)
    print("Saved 2mm NiftyMIC QC figures")
    print("=" * 80)
    print("QC dir:", qc_dir)
