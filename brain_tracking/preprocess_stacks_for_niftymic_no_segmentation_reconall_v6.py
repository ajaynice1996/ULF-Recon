...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output-dir", type=str, default="DataSRR/volunteer_xxx/10mm/npy/native_niftymic_inputs_thr40/reconall_v6_no_seg")
    p.add_argument("--fixed-fig-dir", type=str, default="DataSRR/volunteer_xxx/figures/reconall_v6_no_seg")
    return p.parse_args()
...
def main() -> None:
    ...
    summary_path = os.path.join(args.output_dir, "preprocess_reconall_v6_no_seg_summary.json")
