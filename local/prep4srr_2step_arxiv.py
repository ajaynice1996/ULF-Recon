import os.path
import sys
sys.path.append('/Users/sairamgeethanath/Documents/Projects/Tools/Low_field/Propsa/Recon/LUMC_NYC_edits')
...
if __name__ == '__main__':
    ...
    if mode == 'scanner':
      ...
      im_xy_folder = '1_xy_Sagittal_circshift.npy'  # sagittal
      ...
      # im_sag = np.moveaxis(im_sag, [0, 1, 2], [0, 1, 2])  # xyz --> xyz
    ...
    if debug is True:
      ...
      im_sr = nib.load('srr_6.nii.gz')
      data = im_sr.get_fdata()
      plot_anatomy_raw(data, clim=[0, 1024])
