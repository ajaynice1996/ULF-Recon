...
make_nifti(im_axial_brain, axial_brain_path, mask=False, res=[2,2,2], dim_info=[2,1,0])
make_nifti(im_sag_brain,   sag_brain_path,   mask=False, res=[2,2,2], dim_info=[0,1,2])
...
# =========================
if visualize:
    plot_anatomy_raw(axial_img.numpy(), clim=[0,2048])
